		...
		<div class="top-header container-fluid no-padding">
			...
			<div class="container">
				...
				<div class="col-md-7 col-sm-6 col-xs-12 info">
					<p><i class="icon icon-Pointer"></i>35, East St, New York, USA</p>
			...
			<div class="container">
				...
				<nav class="navbar ow-navigation">
					<div class="navbar-header">
						...
						<a title="Logo1" href="/" class="navbar-brand"><img src="images/logo.png"></a>
					</div>
					<div class="navbar-collapse collapse" id="navbar">
						<ul class="nav navbar-nav">
							<li class="dropdown active">
								<a href="/" title="Pages" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">Home</a>
								<i class="ddl-switch fa fa-angle-down"></i>
								<ul class="dropdown-menu">	
									<li><a href="/" title="HomePage 1">HomePage 1</a></li>
							...
							<li class="dropdown">
								<a href="/gallery" title="Gallery" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">Gallery</a>
								<i class="ddl-switch fa fa-angle-down"></i>
								<ul class="dropdown-menu">	
									<li><a title="Gallery Single" href="/gallerysingle">Gallery Single</a></li>
								</ul>
							</li>
							<li class="dropdown">
								...
								<ul class="dropdown-menu">	
									...
									<li><a title="Blog Post" href="/blogpost">Blog Post</a></li>
									<li><a title="404" href="/error">404</a></li>
								</ul>
							</li>
		...
		<div class="top-footer">
			...
			<div class="container">
				...
				<aside class="col-md-3 col-sm-6 col-xs-6 ftr-widget widget_about">
					<h3 class="widget-title">about our <span>MAX</span></h3>
				...
				<aside class="col-md-2 col-sm-6 col-xs-6 ftr-widget widget_links">
					...
					<ul>
						...
						<li><a href="#" title="Our Packages">Our Packages</a></li>
